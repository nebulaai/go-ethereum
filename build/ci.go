...
import (
	...
	"github.com/nebulaai/nbai-node/internal/build"
	"github.com/nebulaai/nbai-node/params"
	sv "github.com/nebulaai/nbai-node/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/nebulaai/nbai-node/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/nebulaai/nbai-node/mobile")
