...
!define HELPURL "https://github.com/nebulaai/nbai-node/issues"
!define UPDATEURL "https://github.com/nebulaai/nbai-node/releases"
!define ABOUTURL "https://github.com/nebulaai/nbai-node#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:30332)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:30332)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:30332)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30332)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 30332 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30332)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30332 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30332)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30332 "" ""
