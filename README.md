...
)](https://godoc.org/github.com/nebulaai/nbai-node)
[![Go Report Card](https://goreportcard.com/badge/github.com/nebulaai/nbai-node)](https://goreportcard.com/report/github.com/nebulaai/nbai-node)
...
| Command    | Description |
|:----------:|-------------|
| **`geth`** | Our main Ethereum CLI client. It is the entry point into the Ethereum network (main-, test- or private net), capable of running as a full node (default), archive node (retaining all historical state) or a light node (retrieving data live). It can be used by other processes as a gateway into the Ethereum network via JSON RPC endpoints exposed on top of HTTP, WebSocket and/or IPC transports. `geth --help` and the [CLI Wiki page](https://github.com/nebulaai/nbai-node/wiki/Command-Line-Options) for command line options. |
